...
?>
<style>
.page-header:before {background: linear-gradient(#229a5b,#065029), url('<?php echo $bgimg; ?>') no-repeat center center;background-color:white;background-size:cover;}
</style>
...
<div class="wrapper" id="full-width-page-wrapper">
	...
	<div class="<?php echo esc_attr( $container ); ?>" id="content">
		...
		<?php if(!is_woocommerce()): ?></div><!-- .row end --><?php endif; ?>
